...
function Footer() {
  return (
    <div className="container border-top mt-5 px-5 py-5">
      ...
      <div className="d-flex gap-3 ms-5">
        <a href="" className="text-muted " style={{ color: "inherit", textDecoration: "none",fontSize:"10px" }}>NSE</a>
        <a href="" className="text-muted" style={{ color: "inherit", textDecoration: "none",fontSize:"10px" }}>BSE</a>
        <a href="" className="text-muted " style={{ color: "inherit", textDecoration: "none",fontSize:"10px" }}>MCX</a>
        <a href="" className="text-muted" style={{ color: "inherit", textDecoration: "none",fontSize:"10px" }}>MESI</a>
        <a href="" className="text-muted" style={{ color: "inherit", textDecoration: "none" ,fontSize:"10px"}}>Terms & conditions</a>
        <a href="" className="text-muted" style={{ color: "inherit", textDecoration: "none",fontSize:"10px" }}>Policies & proceudres</a>
        <a href="" className="text-muted" style={{ color: "inherit", textDecoration: "none",fontSize:"10px" }}>Privacy policy</a>
        <a href="" className="text-muted" style={{ color: "inherit", textDecoration: "none" ,fontSize:"10px"}}>Disclosure</a>
        <a href="" className="text-muted" style={{ color: "inherit", textDecoration: "none",fontSize:"10px" }}>For investor's attention</a> 
        <a href="" className="text-muted" style={{ color: "inherit", textDecoration: "none",fontSize:"10px" }}>Investor charter</a> 
        <a href="" className="text-muted" style={{ color: "inherit", textDecoration: "none",fontSize:"10px" }}>Sitemap</a>
      </div>
    </div>
  );
}
